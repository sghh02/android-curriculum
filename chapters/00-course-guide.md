...
3. **動作確認（30分）**：チェックポイントを埋める（確認手順をメモする）
...
**週4回以上取り組むと習慣化しやすい**という研究があります。最初は「週6時間」という時間目標より、「週4日以上触れる」という頻度を優先してください。

### 最初の2週間：まず「開く習慣」をつける

- 最初は **1日15分でもOK**（Android Studioを開いて1行読むだけでも可）
- 「やらなきゃ」ではなく「開くだけ」から始める
- 週4日以上できるようになったら、徐々に時間を伸ばす

この「小さく始めて頻度を上げる」習慣づくりは、**エンジニアになってからも一生使えるスキル**です。新しい技術を学ぶとき、業務で忙しいときも「毎日少しだけでも触る」ができる人は成長が止まりません。

### 慣れてきたら：週6時間を目安に

習慣がついたら「2時間 × 3回」などに時間を伸ばしてください（例：平日2回 + 週末1回）。
...
- [ ] 週1回はPRを出す（小さくてOK）
- [ ] PR本文テンプレ（目的/変更内容/確認手順/リスク）を毎回埋める
...
```text
【前提】
週4日以上の頻度を目標にこのコースを進めています（この章のコンテキストは共有済み）。
...
```text
【質問】
週4日以上触れる習慣をつけたい。1回15〜30分でできる「小さなタスク」を、
今週分として4〜5個提案して。
```
...
```text
【レビュー】
このPR説明文を、目的/変更内容/確認手順/リスクの形に整えて。
（ここにPR本文を貼る）
```
...
- 週4日以上触れるために、どの曜日・時間帯に取り組めそう？
- 最初の2週間、ハードルを下げるために「これだけやる」と決める最小目標は？
- 「読むだけ」で終わらせないために、毎週残す学習の記録（PR）は何にする？
- 6ヶ月後、どんなアプリが作れたら嬉しい？
