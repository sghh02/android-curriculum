...
<!-- codelab:basic-android-kotlin-compose-datastore -->
出典: [DataStore を使用して設定をローカルに保存する](https://developer.android.com/codelabs/basic-android-kotlin-compose-datastore?hl=ja)（Google Developers, CC BY 4.0）
