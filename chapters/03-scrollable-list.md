...
出典: [スクロール可能なリストを追加する](https://developer.android.com/codelabs/basic-android-kotlin-compose-training-add-scrollable-list?hl=ja)（Google Developers, CC BY 4.0）
...
<!-- codelab:basic-android-kotlin-compose-training-change-app-icon -->
出典: [アプリアイコンを変更する](https://developer.android.com/codelabs/basic-android-kotlin-compose-training-change-app-icon?hl=ja)（Google Developers, CC BY 4.0）
...
<!-- codelab:basic-android-kotlin-compose-practice-grid -->
出典: [演習: グリッドを作成する](https://developer.android.com/codelabs/basic-android-kotlin-compose-practice-grid?hl=ja)（Google Developers, CC BY 4.0）
