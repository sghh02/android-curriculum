...
| 5 | クイズ | [テスト: UI と状態を操作する](https://developer.android.com/courses/quizzes/android-basics-compose-unit-2-pathway-3/android-basics-compose-unit-2-pathway-3?hl=ja) | 約15分 | リンク先で受ける |
