...
> **注:**Android アプリのアクティビティは複数にすることもできますが、これまでこのプログラムで実装しているように、アクティビティは 1 つにすることをおすすめします。
...
ドメインレイヤという別のレイヤを追加することで、UI レイヤとデータレイヤの間のやり取りを簡素化でき、再利用できます。このレイヤは省略でき、このプログラムでは扱いません。
...
- 「Compose での ViewModel と状態」のレッスンを完了していること
