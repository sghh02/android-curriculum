...
- [ナビゲーション](./07-navigation.md) を完了し、画面遷移の骨格がある
...
1. 上記の演習を完了する
2. GitHub で `feature/08-architecture` ブランチを作成し、PRを作成
...
次は [Unit 4: 非同期処理とネットワーク（ガイド）](./04-unit4-guide.md) に進み、非同期とネットワークの全体像を確認しましょう。
