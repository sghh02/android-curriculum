...
> 提出ブランチ：`feature/15-project`（PRのbase：`main`）
...
- [ ] 各PRに「目的/変更内容/スクショ/テスト結果/リスク」を書く
...
| PR | 説明が弱い | 要点/スクショあり | 影響範囲/確認手順/リスクまで書ける |
...
```text
【PR文章】
このPR説明文を、レビュアーが判断しやすい形に整えて（目的/変更内容/スクショ/テスト結果/リスク）。
（ここにPR本文を貼る）
```
