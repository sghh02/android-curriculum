...
- [Unit 1: プログラミングとAndroidの基礎（ガイド）](./01-unit1-guide.md) を読んでいる
- つまずいたら [デバッグと調査（実務の型）](./16-debugging.md) の「調査の型」を参照できる
...
5. 仮想化が使えない場合は、実機（USBデバッグ）で動作確認する
...
- [ ] 新規プロジェクトを作成し、エミュレータ/実機で起動できる（確認手順をメモする）
- [ ] 「よくあるエラー」から1つ選び、原因と対処を自分の言葉でメモする
- [ ] 学習用リポジトリにPRを作り、環境構築の完了を“記録”として残す
...
- 学習の記録（PR）を、どの頻度で残せそう？

---

## 次の章

次は [Kotlinプログラミングの基礎](./02-kotlin-basics.md) に進み、Kotlinの基礎文法を固めましょう。
